...
const styles = StyleSheet.create({
  ...
  scanerButton: { backgroundColor: '#eba0ac', padding: 15, borderRadius: 8, alignItems: 'center', marginTop: 'auto', borderWidth: 1, borderColor: '#d17c8b' },
  scanerButtonText: { color: '#181825', fontSize: 16, fontWeight: 'bold' }
});
